...
| RG-19 | Chaque tâche possède un titre et une description et peut avoir un responsable de tâche facultatif choisi parmi les membres du projet. Aucune échéance ni priorité. Les colonnes À faire, En cours et Fait sont envisagées ; leur personnalisation reste à arbitrer, Q-01. Le détail du cycle de vie des tâches est suivi en Q-26. Le Kanban est intégré dans l’onglet Description du projet, sans onglet Kanban distinct. Le passage de la dernière tâche non terminée à l’état terminé déclenche la clôture automatique définie en RG-20. |
