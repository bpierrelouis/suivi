...
| RG-04 | Il existe au plus un gestionnaire. Seul l’administrateur attribue ou retire ce rôle. La nomination remplace atomiquement le gestionnaire précédent, refuse un responsable de projet actif et retire les autres participations du candidat ; le retrait rend le compte utilisateur sans restaurer ces participations. |
...
| ID | Règle |
| --- | --- |
| RG-15 | L’administrateur et l’utilisateur créent un projet avec nom, description et visibilité publique ou privée. La personne à l’origine du projet en devient le responsable et un membre. Les dates sont facultatives. Un membre ou l’administrateur peut modifier ces informations tant que le projet est actif ; les dates ne déplacent aucune réservation automatiquement. |
...
| RG-18 | L’ajout d’un compte existant comme membre est immédiat, sans invitation. Les membres peuvent modifier les informations, gérer les tâches et ajouter des membres. Seul l’administrateur retire un membre non responsable ; ses tâches deviennent sans responsable. Le responsable ne peut pas être retiré. |
| RG-19 | Chaque tâche possède un titre et une description et peut avoir un responsable facultatif choisi parmi les membres. Aucune échéance ni priorité. Les colonnes fixes sont À faire, En cours et Fait ; les membres et l’administrateur peuvent créer, modifier, déplacer et supprimer une tâche d’un projet actif. Le Kanban est intégré dans la fiche du projet. Le passage de la dernière tâche non terminée à Fait déclenche la clôture automatique définie en RG-20. |
| RG-20 | Responsable du projet et administrateur peuvent clôturer ou archiver un projet ; clôture et archivage sont une même action produisant le même état. Le système déclenche aussi cette clôture automatiquement lorsque la dernière tâche non terminée passe à l’état terminé ; un projet sans tâche n’est pas clôturé automatiquement. Les matériels réservés sont immédiatement libérés et la trace des affectations conservée. Les droits des autres membres restent à arbitrer. Un projet archivé ne peut pas être rouvert. |
...
| RG-33 | Chaque projet possède une documentation Markdown de type `README.md`, modifiable par ses membres et l’administrateur, lisible par toute personne autorisée et exportable en DOCX. La syntaxe couvre titres, paragraphes, listes, gras, italique, code en ligne et liens HTTP/HTTPS ; les images et versions sont exclues. |
