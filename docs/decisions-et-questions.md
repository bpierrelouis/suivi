...
| Q-26 | Confirmer création, modification, déplacement et éventuelle suppression des tâches ; champs obligatoires hors responsable de tâche facultatif décidé en D-02, ordre et comportement des tâches non terminées lors d’une clôture manuelle. La clôture automatique au passage de la dernière tâche à l’état terminé est décidée en D-13. | US-19, US-20, dictionnaire. | Avant Kanban. |
